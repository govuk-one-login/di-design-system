document.addEventListener('DOMContentLoaded', function () {
  ...
  // Tabs — no tab open by default, open on click, arrow key navigation
  document.querySelectorAll('[data-module="app-tabs"]').forEach(function (tabsEl) {
    ...
    function selectTab(selectedTab) {
      ...
      tabs.forEach(function (tab) {
        ...
        tab.parentElement.classList.toggle('govuk-tabs__list-item--selected', isSelected);
      });
      panels.forEach(function (panel) {
        panel.classList.toggle('govuk-tabs__panel--hidden', panel.id !== targetId);
      });
      selectedTab.focus();
    }
